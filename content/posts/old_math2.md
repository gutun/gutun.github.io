---
title: 旧笔记(2) - 抽卡中的概率问题（2）
subtitle:
date: 2026-01-10T10:15:51+08:00
slug: 0338156
draft: false
author:
  name: GUTUN
...
**评价于2026年1月10日**：我想起后续我学习随机过程课程的时候，意识到这个问题是一个随机过程的问题，常返马氏链的返回步数的期望正是平稳分布的倒数，把保底为$n$次的抽卡当做有$n$个状态的马氏链，在起点状态(即一发未抽或者刚出货的状态)的返回步数的期望正是上述解。不过似乎倒也不必用更高级的理论降维打击，现在对于这个问题，无论如何大模型都可以轻松地给出解决了，而我也不再研究这些问题了。